...
public class OIExportIssueRunTimeCheck {
	public static void main(String[] args) throws IOException {
	    ...
	    JSONArray jsonMsgItem = (JSONArray) jsonMsgData.get("export");
...
//	    		String projectName = projectNameRaw.substring(0, projectNameRaw.indexOf("_房屋查验报告"));
	   ...
	   //System.out.println(longTimeExecutionList);
	    ...
	    if(longTimeExecuteCnt >= 1) {
	        ...
	        String msgToSend1 = "业主验房过去一个小时有" + longTimeExecuteCnt + "个问题导出任务执行超过三分钟才结束（或者还在执行中）。"  + "任务详情如下：" + "\\n"
