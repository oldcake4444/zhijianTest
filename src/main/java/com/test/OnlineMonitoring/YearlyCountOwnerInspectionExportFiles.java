...
public class YearlyCountOwnerInspectionExportFiles {
	
    private static final String urlStr = "https://open1.feishu1.cn/open-apis/bot/v2/hook/d63f293b-9438-4c0c-a103-9dec1246d7bd/;https://open.feishu1.cn/open-apis/bot/v2/hook/ddd02a94-ae18-4454-9746-e9cc44f469b5/";
	...
	public static void main(String[] args) throws IOException {
        ...
        long firstDateLong = calendar.getTimeInMillis();
        calendar.setTimeInMillis(firstDateLong);
        long firstDateOfLastYearLong = firstDateLong/1000;
        ...
        long lastDateLong = calendar.getTimeInMillis();
        calendar.setTimeInMillis(lastDateLong);
        long lastDateOfLastYearLong = lastDateLong/1000;
        SimpleDateFormat df2 = new SimpleDateFormat("yyyy");
        String lastYear = df2.format((Date)calendar.getTime());
        ...
        String params = "sign=41d1c8a9dfbf41b74d74df0a9f0d5642&export_type=[5,10]&status=30&create_at_start=" + firstDateOfLastYearLong + 
                "&create_at_end=" + lastDateOfLastYearLong;       
...
//        String exportCnt = msg.substring(msg.indexOf("\"count\":") + keyWord1.length(), msg.indexOf("}}"));
        ...
        for(int i=0; i<rptExpArray.size(); i++) {
	    	...
	    	if(groupId != 146208 && groupId != 100546) { // 排除测试集团
...
//	    }
        ...
        System.out.println(groupCnt + ", " + exportTaskCntExcludeTest);
...
//                         LinkedHashMap::new));
        ...
        for(int i = 0; i < urlString.length; i++) {
            ...
            if(exportPdfCntExcludeTest == 0) {
                msgToSend = lastYear + "年业主验房没有PDF导出";
                postMsg = "{\"msg_type\":\"text\",\"content\":{\"text\":\"" + msgToSend + "\"}}";        
                System.out.print(postMsg);            
            } else {
                msgToSend = lastYear + "年业主验房导出" + exportPdfCntExcludeTest + "个PDF文件，"
                		+ "涉及" + groupCnt + "个集团，总共" +  
