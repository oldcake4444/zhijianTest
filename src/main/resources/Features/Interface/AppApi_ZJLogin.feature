...
Feature: App login API test for different envs
  ...
  Scenario Outline: Test for app login api
    ...
    Examples: 
      ...
      | "appapilogin_001" | "prod"   | "kentest40"   | "12345678" | "device_id;password;username" | "115430;肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆肆;kentest40;0" | "id;real_name;user_name;delete_at" |
