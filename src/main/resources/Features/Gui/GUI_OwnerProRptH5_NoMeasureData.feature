...
Feature: Verify the H5 report page of owner inspection
  ...
  Scenario Outline: Test for house professional report page
    ...
    Then I verify <pageInfo> can be found on the page and the summary contains <summaryInfo> and <issueData> but without <measureData>
    ...
    Examples: 
      ...
      | "guiOwnerProRpt_001" | "prod" | "moon2" | "12345678" | ""        | "146208" | "146210" | "128673"  | "46"   | ""      | "汇总分析"   | "分别为"       | "房屋质量得分"     | "生成报告"       | "重新生成PDF1"           | "重新生成PDF2"           | "按分类等待"         | "按区域等待"         | "按检查项下载" | "按区域下载" | "guiOwnerProRpt_001" | "实测数据"      | "隐患明细"    |
